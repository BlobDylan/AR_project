...
output_path = "output_drawings2.avi"
replacement_image_path = "uno.png"
...
overlay_image = cv2.imread(replacement_image_path)
...
while cap.isOpened():
    ...
    if len(good_matches) > min_good_matches:
        ...
        if H is not None:
            ...
            # draw the overlay or the frame depending on the mask
            frame = np.where(mask_overlay == 0, frame, warped_overlay)
